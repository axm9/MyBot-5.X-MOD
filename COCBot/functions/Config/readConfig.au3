...
Func readConfig() ;Reads config and sets it to the variables
	...
	If FileExists($config) Then
		...
		$iMinGold[$TS] = IniRead($config, "advanced", "TSsearchGold", "100000")
		$iMinElixir[$TS] = IniRead($config, "advanced", "TSsearchElixir", "100000")
		...
		$MilkFarmElixirParam = StringSplit(IniRead($config, "MilkingAttack", "LocateElixirLevel", "-4|4|3|3|2|2|1|1|1"), "|", 2)
		If Ubound($MilkFarmElixirParam) <> 9 Then $MilkFarmElixirParam = StringSplit("4|4|3|3|2|2|1|1|1", "|", 2)
		...
		$MilkFarmLimitGold = IniRead($config, "MilkingAttack", "LimitGold", "100000")
		$MilkFarmLimitElixir = IniRead($config, "MilkingAttack", "LimitElixir", "100000")
		$MilkFarmLimitDark = IniRead($config, "MilkingAttack", "LimitDark", "500")
		$MilkFarmResMaxTilesFromBorder = IniRead($config, "MilkingAttack", "MaxTiles", "3")
