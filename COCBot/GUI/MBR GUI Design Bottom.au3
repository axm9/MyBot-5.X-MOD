...
$grpVillage = GUICtrlCreateGroup(GetTranslated(13,21, "Village"), $x - 20, $y - 20, 190, 85)
	...
	$btnQuickStats = GUICtrlCreateButton(GetTranslated(13,28, "Avg."), $x + 125 , $y -25, 40, -1)
		GUICtrlSetOnEvent(-1, "btnVillageStat")

 	;$btnBoostVillage = GUICtrlCreateButton("Boost", $x + 25 , $y + 54, 100, 18)
 	;	GUICtrlSetOnEvent(-1, "btnBoostVillage")
