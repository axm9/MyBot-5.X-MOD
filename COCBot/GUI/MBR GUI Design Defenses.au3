...
Func GUI3()
	...
	$chkInferno = GUICtrlCreateCheckbox(GetTranslated(16,4, "Enable Inferno Tower detection"), $x, $y)
		$txtTip = $txtTip1 & @CRLF & GetTranslated(16,5, "Inferno Tower near TownHall.")
		GUICtrlSetTip(-1, $txtTip)
		GUICtrlSetState(-1, $GUI_CHECKED)
		GUICtrlSetOnEvent(-1, "chkInferno")
	$y += 25
	$chkMortar = GUICtrlCreateCheckbox(GetTranslated(16,6, "Enable Mortar detection"), $x, $y)
		$txtTip = $txtTip1 & @CRLF & GetTranslated(16,7, "Mortar near TownHall.")
		GUICtrlSetTip(-1, $txtTip)
		GUICtrlSetState(-1, $GUI_CHECKED)
	...
	$slddefTolerance = GUICtrlCreateSlider(5, $y, 230, 20, BITOR($TBS_TOOLTIPS, $TBS_AUTOTICKS))
