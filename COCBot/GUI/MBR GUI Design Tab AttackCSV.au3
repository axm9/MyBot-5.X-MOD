...
$tabAttackCSV = GUICtrlCreateTabItem(GetTranslated(14,1, "Attack Scripted"))
	Local $x = 30, $y = 150
	$grpDeadBaseDeployCSV = GUICtrlCreateGroup(GetTranslated(14,2, "DeadBase Deploy"), $x - 20, $y - 20, 225, 315)
	...
	Local $x = 260, $y = 150
	$grpLiveBaseDeployCSV = GUICtrlCreateGroup(GetTranslated(14,12, "LiveBase Deploy"), $x - 20, $y - 20, 220, 315)
