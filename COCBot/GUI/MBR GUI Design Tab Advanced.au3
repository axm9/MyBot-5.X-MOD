...
$tabAttackAdv = GUICtrlCreateTabItem(GetTranslated(4,1, "Attack Adv."))
	...
	Local $x = 30, $y = 355
	$grpDefenseFarming = GUICtrlCreateGroup(GetTranslated(4,79, "Attack Scheduler"), $x - 20, $y - 20, 220, 170)
		$x -= 10
		$chkattackHours = GUICtrlCreateCheckbox("Attack only during these hours of day", $x, $y)
		GUICtrlSetOnEvent(-1, "chkattackHours")
		$y += 20
		$lbattackhours1 = GUICtrlCreateLabel(" 0", $x + 20, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$lbattackhours2 = GUICtrlCreateLabel(" 1", $x + 35, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$lbattackhours3 = GUICtrlCreateLabel(" 2", $x + 50, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$lbattackhours4 = GUICtrlCreateLabel(" 3", $x + 65, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$lbattackhours5 = GUICtrlCreateLabel(" 4", $x + 80, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$lbattackhours6 = GUICtrlCreateLabel(" 5", $x + 95, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$lbattackhours7 = GUICtrlCreateLabel(" 6", $x + 110, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$lbattackhours8 = GUICtrlCreateLabel(" 7", $x + 125, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$lbattackhours9 = GUICtrlCreateLabel(" 8", $x + 140, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$lbattackhours10 = GUICtrlCreateLabel(" 9", $x + 155, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$lbattackhours11 = GUICtrlCreateLabel("10", $x + 170, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$lbattackhours12 = GUICtrlCreateLabel("11", $x + 185, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$y += 15
		$chkattackhours0 = GUICtrlCreateCheckbox("", $x + 20, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours1 = GUICtrlCreateCheckbox("", $x + 35, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours2 = GUICtrlCreateCheckbox("", $x + 50, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours3 = GUICtrlCreateCheckbox("", $x + 65, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours4 = GUICtrlCreateCheckbox("", $x + 80, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours5 = GUICtrlCreateCheckbox("", $x + 95, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours6 = GUICtrlCreateCheckbox("", $x + 110, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours7 = GUICtrlCreateCheckbox("", $x + 125, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours8 = GUICtrlCreateCheckbox("", $x + 140, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours9 = GUICtrlCreateCheckbox("", $x + 155, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours10 = GUICtrlCreateCheckbox("", $x + 170, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours11 = GUICtrlCreateCheckbox("", $x + 185, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$lbattackhoursAM = GUICtrlCreateLabel("AM", $x, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		$y += 15
		$chkattackhours12 = GUICtrlCreateCheckbox("", $x + 20, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours13 = GUICtrlCreateCheckbox("", $x + 35, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours14 = GUICtrlCreateCheckbox("", $x + 50, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours15 = GUICtrlCreateCheckbox("", $x + 65, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours16 = GUICtrlCreateCheckbox("", $x + 80, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours17 = GUICtrlCreateCheckbox("", $x + 95, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours18 = GUICtrlCreateCheckbox("", $x + 110, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours19 = GUICtrlCreateCheckbox("", $x + 125, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours20 = GUICtrlCreateCheckbox("", $x + 140, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours21 = GUICtrlCreateCheckbox("", $x + 155, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours22 = GUICtrlCreateCheckbox("", $x + 170, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$chkattackhours23 = GUICtrlCreateCheckbox("", $x + 185, $y, 15, 15)
		GUICtrlSetState(-1, $GUI_CHECKED + $GUI_DISABLE)
		$lbattackhoursPM = GUICtrlCreateLabel("PM", $x, $y)
		GUICtrlSetState(-1, $GUI_DISABLE)
		
		$y += 20
		$chkLogOffIfAttackDisabled = GUICtrlCreateCheckbox("Stay offline when attack is disabled", $x, $y)
		GUICtrlSetOnEvent(-1, "chkLogOffIfAttackDisabled")
    GUICtrlCreateGroup("", -99, -99, 1, 1)
