...
$tabAttackAdv = GUICtrlCreateTabItem(GetTranslated(4,1, "Attack Adv."))
	...
	$grpTHSnipeWhileTrainOptions = GUICtrlCreateGroup(GetTranslated(4,13, "TH Snipe"), $x - 20, $y - 20, 225, 375)
		...
		$y += 30
		$chkTSAttackIfDB = GUICtrlCreateCheckbox(GetTranslated(4,38, "Greedy Mode"), $x , $y, -1, -1)
			$txtTip = GetTranslated(4,39, "Check loot gained by TH snipe to see if it's a dead base and attack it normally.")
