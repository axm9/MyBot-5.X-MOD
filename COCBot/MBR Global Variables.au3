...
Global $dirStats = $sProfilePath & "\" & $sCurrProfile & "\Stats\"
...
Global $statChkTownHall = $dirStats & "stats_chktownhall.ini"
Global $statChkDeadBase = $dirStats & "stats_chkelixir.ini"
Global $statChkDeadBase75percent = $dirStats & "stats_chkelixir75percent.ini"
Global $statChkDeadBase50percent = $dirStats& "stats_chkelixir50percent.ini"
Local $datetimeString = @YEAR & "-" & @MON & "-" & @MDAY & "_" & @HOUR & "." & @MIN & "." & @SEC
Global $statHourlyLoots = $dirStats & "stats_hourly_loots_" & $datetimeString &".ini"
...
Global $pImgLib = $LibDir & "\ImgLoc.dll" ; Latest Image Library from @trlopes with all Legal Information need on LGPL
...
Global Const $CenterX = 425, $CenterY = 330, $THEllipseWidth = 200, $THEllipseHeigth = 150, $CollectorsEllipseWidth = 130, $CollectorsEllipseHeigth = 97.5
...
; Building Side (DE/TH) Switch and DESide End Early
...
Global $MilkFarmElixirParam = StringSplit("4|4|3|3|2|2|1|1|1", "|", 2)
...
Global $MilkFarmLimitGold = 100000
Global $MilkFarmLimitElixir = 100000
Global $MilkFarmLimitDark = 500
